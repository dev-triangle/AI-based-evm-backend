...
from .views import (BlacklistTokenView,LoggedInUserView,RegisterView,UserDetailViewset,UserViewset,ElectionViewset,CandidateViewset,recognize_face,ImagerecViewset,test_face,VoteViewset)
